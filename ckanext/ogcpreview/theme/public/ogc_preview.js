    ...
    loadPreviewDialog: function (resourceData) {
      ...
      if (['wfs', 'ogc:wfs'].indexOf(format) > -1) {
        ...
        (function () {
          ...
          baseMapUrl = 'https://api.tiles.mapbox.com/v4/mapbox.outdoors/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiZ2FyeWh1ZG1hbiIsImEiOiJjaW14dnV2ZzAwM2s5dXJrazlka2Q2djhjIn0.NOrl8g_NpUG0TEa6SD-MhQ',          baseMap = new L.TileLayer(baseMapUrl, {
            subdomains: '1234',
            detectRetina: true,
